                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form method="post" action="{{ url('/administrator/produk') }}">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <textarea id="deskripsi" name="deskripsi" type="text" class="form-control" value="{{ old('deskripsi') }}">{{ old('deskripsi') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
