        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ url('/administrator') }}" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/administrator/produk') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/administrator/vendor') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/administrator/stokmasuk') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/administrator/pesanan') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/administrator/users') }}" class="nav-link">
